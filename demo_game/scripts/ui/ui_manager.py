...
class UIManager:
    ...
    def render_player_status(self):
        ...
        center_coord = (self.game.internal_w // 2, self.game.internal_h - 24)
        rect = text.get_rect( center=center_coord )
    ...
    def create_centered_buttons(self, buttons, start_y, spacing=70):
        ...
        for idx, button in enumerate(buttons):
            center_coord = (self.game.internal_w // 2, start_y + idx * spacing)
            rect = button.image.get_rect(center=center_coord)
            button.rect = rect
    ...
    def render_buttons(self, buttons):
        ...
        for button in buttons:
            button.render(self.game.display, mouse_pos, clicked)